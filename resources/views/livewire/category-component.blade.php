                        ...
                        <li class="col-lg-4 col-md-6 col-sm-6 col-xs-6 ">
                            <div class="product product-style-3 equal-elem ">
                                <div class="product-thumnail">
                                    ...
                                    @else    
                                    <label class="salevalue">-{{number_format(($product->regular_price-$product->sale_price)/($product->regular_price)*100,1)}}%</label>
                                    @endif
                                </div>
                                <div class="product-info">
                                    <div class="product-info-text">
                                        ...
                                        @else
                                        <div class="wrap-price"><span class="product-price">{{ number_format($product->regular_price,0)  }} VNĐ</span></div>
                                        <div class="wrap-price" style="text-decoration: line-through">{{ number_format($product->sale_price,0)  }} VNĐ</div>
                                        @endif
                                    </div>
                                </div>
