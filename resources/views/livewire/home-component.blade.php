                                ...
                                <div class="product product-style-2 equal-elem ">
                                    <div class="product-thumnail">
                                        <a href="{{ route('product.details',['slug'=>$lproduct->slug]) }}" title="T-Shirt Raw Hem Organic Boro Constrast Denim">
                                            <figure><img src="{{('  assets/images/products/')}}/{{ $lproduct->image }}" width="800" height="800" alt="T-Shirt Raw Hem Organic Boro Constrast Denim"></figure>
                                            {{-- @if ($lproduct->sale_price<1)
                                            @else    
                                            <label class="salevalue">-{{number_format(($lproduct->regular_price-$lproduct->sale_price)/($lproduct->regular_price)*100,1)}}%</label>
                                            @endif --}}
                                        </a>
                                        <div class="group-flash">
                                    ...
                                    <div class="product-info">
                                        ...
                                        <div class="wrap-price"><p class="product-price" style="text-decoration: line-through">{{ $lproduct->regular_price }} VNĐ</p>  <span  class="product-price">&nbsp;&nbsp;{{ $lproduct->sale_price}} VNĐ</span></div>
